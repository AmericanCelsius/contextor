...
- Added macOS fresh-clone startup scripts that install dependencies, build, optionally link `contextor`, and launch the TUI without requiring a preexisting global command.
